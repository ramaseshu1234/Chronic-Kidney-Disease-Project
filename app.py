...
def predict():
    ...
    if prediction == 1:
        return render_template('result.html',pred=f'You are not safe! You have Kidney Disease')
    else:
        return render_template('result.html',pred=f'You are safe! You do not have Kidney Disease')
